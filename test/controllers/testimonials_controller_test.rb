...
class TestimonialsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create testimonial" do
    assert_difference('Testimonial.count') do
      post testimonials_url, params: { testimonial: { accessories: @testimonial.accessories, airblades: @testimonial.airblades, category_pages: @testimonial.category_pages, description: @testimonial.description, fans: @testimonial.fans, homepage: @testimonial.homepage, lighting: @testimonial.lighting, testimonials: @testimonial.testimonials, title: @testimonial.title, vacuums: @testimonial.vacuums } }
    end
  ...
  test "should update testimonial" do
    patch testimonial_url(@testimonial), params: { testimonial: { accessories: @testimonial.accessories, airblades: @testimonial.airblades, category_pages: @testimonial.category_pages, description: @testimonial.description, fans: @testimonial.fans, homepage: @testimonial.homepage, lighting: @testimonial.lighting, testimonials: @testimonial.testimonials, title: @testimonial.title, vacuums: @testimonial.vacuums } }
